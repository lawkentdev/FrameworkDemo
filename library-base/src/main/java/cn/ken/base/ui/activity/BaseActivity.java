package cn.ken.base.ui.activity;
...
import cn.ken.base.ui.adapter.BaseActionBarAdapter;
import cn.ken.base.ui.delegate.BaseDelegate;
import cn.ken.base.util.AppManager;
import cn.ken.res.dialog.LoadingDialog;
...
public abstract class BaseActivity<S extends BaseDelegate> extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        immersionBar = ImmersionBar.with(this).fullScreen(true).statusBarDarkFont(true);
        immersionBar.init();
