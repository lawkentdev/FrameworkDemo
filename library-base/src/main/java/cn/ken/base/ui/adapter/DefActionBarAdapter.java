...
public class DefActionBarAdapter implements BaseActionBarAdapter {
    ...
    public void injectView(ViewGroup root) {
        View head = LayoutInflater.from(root.getContext()).inflate(cn.ken.res.R.layout.activity_base_head, null);
    ...
    public void hideStatusBar() {
        layoutBaseStatusBar.setVisibility(View.GONE);
    }

    @Override
    public void showStatusBar() {
        layoutBaseStatusBar.setVisibility(View.VISIBLE);
    }
